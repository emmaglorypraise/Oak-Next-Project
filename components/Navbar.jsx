  ...
  return (
    <>
      <nav className='flex items-center flex-wrap justify-between pt-[20px] pb-[10px] px-[20px]  md:p-[40px] '>
        ...
        <button className=' inline-flex p-3 hover:bg-[#9E2F92] rounded lg:hidden text-[#9E2F92] ml-auto hover:text-white outline-none'
        onClick={handleClick}
        >
          <svg
            className='w-6 h-6'
        ...
        >
            <div className='flex lg:flex-row flex-col justify-evenly pl-[5px] mt-3 lg:mt-0  lg:items-center lg:ml-[20px] lg:gap-[59px] font-normal text-base text-[#3A3737CC]'>
                  <span className='font-medium  mb-2 lg:mb-0'><Link href="/">Dashboard</Link></span>
                  <span  className='font-medium mb-2 lg:mb-0'><Link href="/calender">Calendar</Link></span>
            ...
            <div className='flex items-center justify-start my-3 lg:my-0 lg:justify-end lg:gap-[21px]'>
              ...
              <IoMdSettings className='mr-4 lg:mr-0' size={20} onClick={() => setShowModal(true)} />
              {showModal ? (
                <>
