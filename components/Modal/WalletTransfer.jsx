            ...
            <div className="relative w-auto  mx-auto max-w-3xl">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                <div className=" px-8 pb-2 mt-4  w-full pt-2 rounded-t ">
                  ...
                  <div>
                  <h3 className="text-center ml-3 font-poppins font-semibold text-[30px] leading-[45px] text-[#3A3737]">Schedule wallet transfer</h3>
                  <p className="text-center font-poppins font-normal text-[15px] leading-[22px] text-off-grey">Transfer crypto to a wallet address</p>
                  </div>
                  </div>
