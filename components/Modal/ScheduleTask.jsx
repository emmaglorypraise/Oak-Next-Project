...
const ScheduleTask = () => {  
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object({
      ...
      message: yup
      .string()
      .required('Enter a note for this task'),
    }),
  });
            ...
            <div className="relative w-auto  mx-auto max-w-3xl">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                <div className=" px-8 pb-2 mt-4  w-full pt-2 rounded-t ">
                  ...
                  <Image src={scheduleIcon} className="px-2 mr-3" width="50" height="50" alt="schedule Icon" />
                  <div>
                  <h3 className="text-center ml-3 font-poppins font-semibold text-[30px] leading-[45px] text-[#3A3737]">Schedule New Task</h3>
                  ...
                  <div hidden={!submitted} className="text-green-600 ml-3 mb-2" role="alert">
                   ...
                   {formik.errors.time && (
                    ...
                    {formik.errors.message && (
                      <div className="text-red-500 mb-3">{formik.errors.message}</div>
                    )}
